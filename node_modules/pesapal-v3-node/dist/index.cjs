...
__export(index_exports, {
  ...
  Pesapal: () => Pesapal,
  PesapalError: () => PesapalError,
  RecurringPayments: () => RecurringPayments,
  Refunds: () => Refunds,
  parseIPN: () => parseIPN,
  verifyIPNSignature: () => verifyIPNSignature
});
...
function verifyIPNSignature(signature, rawBody, consumerSecret) {
  const hmac = (0, import_node_crypto.createHmac)("sha256", consumerSecret);
