...
// Exports all validation functions needed by all routes
// ============================================
...
// Passthrough validators for other routes that might need them
const validateCreateProperty = (req, res, next) => next();
const validateUpdateProperty = (req, res, next) => next();
const validateCreateReview = (req, res, next) => next();
const validateUpdateReview = (req, res, next) => next();
